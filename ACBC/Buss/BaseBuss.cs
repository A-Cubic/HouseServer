        ...
        private object HeaderBussResults(Controller controller, BaseApi baseApi)
        {
            ...
            else
            {
                ...
                catch (Exception ex)
                {
                    ...
                    {
                        message = new Message(CodeMessage.InnerError, ex.ToString() + "####" + System.Environment.GetEnvironmentVariable("PtsUrl"));
                    }
                }
                if (message != null)
                {
        ...
        private object BodyBussResults(Controller controller, BaseApi baseApi)
        {
            ...
            else
            {
                ...
                catch (Exception ex)
                {
                    ...
                    {
                        message = new Message(CodeMessage.InnerError, ex.ToString()+"####"+ System.Environment.GetEnvironmentVariable("MysqlDBUrl"));
                    }
                }
